...
def test_history_lists_completions_newest_first(client):
    ...
    older = Completion.objects.create(
        chore=_make_chore(alice, "Dishes"), completed_by=alice
    )
    Completion.objects.create(chore=_make_chore(alice, "Trash"), completed_by=alice)
...
def test_history_member_filter_narrows(client):
    ...
    Completion.objects.create(chore=_make_chore(alice, "Dishes"), completed_by=alice)
    Completion.objects.create(chore=_make_chore(bob, "Laundry"), completed_by=bob)
    _select_member(client, alice)
